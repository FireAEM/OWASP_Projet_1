<?php
    ...
    if (isset($_SESSION['id_utilisateur'])) {
        $id_role_utilisateur = $_SESSION['id_role_utilisateur'];
                    ...
                    if (!empty($messages)): ?>
                        <?php foreach ($messages as $message): ?>
                            <div class="adminMessageItem">
                                <div>
                                    <p>Nom : <?php echo htmlspecialchars($message['nom']); ?></p>
                                    <p>Prénom : <?php echo htmlspecialchars($message['prenom']); ?></p>
                                    <p>Email : <?php echo htmlspecialchars($message['email']); ?></p>
                                </div>
                                <p>Message : <?php echo htmlspecialchars($message['contenu']); ?></p>
                            </div>
                        <?php endforeach; ?>
                    <?php else: ?>
